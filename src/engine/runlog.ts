...
const ROUTINE_TOOLS: Record<RoutineKey, string[]> = {
  ...
  acquire: [...ALWAYS_ALLOWED, "propose_idea", "classify", "save_enrichment", "upsert_playbook", "plan_goal", "what_works", "verifiers", "set_checks", "view_asset", "describe_asset", "get_brand"],
