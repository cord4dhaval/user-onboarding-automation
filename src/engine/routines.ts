...
3.4 lost-reader
  next_work("lost"): leads the sales team closed as lost whose reason has not been
  read under the rule in force. Each item carries the words the rep typed, what is
  still queued for them, and what an older rule made of it — answer from that alone,
  with one classify_lost call for the batch, then finish_work. A row carrying
  previous_bucket is in front of you again after a rule change; answer it even if
