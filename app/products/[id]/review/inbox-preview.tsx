...
export default function InboxPreview({
  ...
  // window, so it follows the drawer through a resize or an edit form opening beside it.
  ...
  const body = html ? (
    <MailFrame
      ...
      fitHeight={compact && fit && device === "web" ? room : undefined}
    />
  ) : (
 ...
 * laptop screen; a longer one scrolls in its box, and 100% shows it at full size.
 */
const MIN_FIT = 0.55;
